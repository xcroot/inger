                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body layui-text">
                        <div class="layuimini-notice">
                            ...
                            <div class="layuimini-notice-extra">2020-03-11 23:06</div>
                        ...
                        <div class="layuimini-notice">
                            ...
                            <div class="layuimini-notice-extra">2021-04-11 12:57</div>
                            <div class="layuimini-notice-content layui-hide">
                                界面足够简洁清爽。<br>
                                一个接口几行代码而已直接初始化整个框架，无需复杂操作。<br>
                                支持多tab，可以打开多窗口。<br>
                        ...
                        <div class="layuimini-notice">
                            ...
                            <div class="layuimini-notice-extra">2021-04-05 14:28</div>
                            <div class="layuimini-notice-content layui-hide">
                                界面足够简洁清爽。<br>
                                一个接口几行代码而已直接初始化整个框架，无需复杂操作。<br>
                                支持多tab，可以打开多窗口。<br>
                        ...
                        <div class="layuimini-notice">
                            ...
                            <div class="layuimini-notice-extra">2021-04-04 11:02</div>
                            <div class="layuimini-notice-content layui-hide">
                                界面足够简洁清爽。<br>
                                一个接口几行代码而已直接初始化整个框架，无需复杂操作。<br>
                                支持多tab，可以打开多窗口。<br>
                        ...
                        <div class="layuimini-notice">
                            ...
                            <div class="layuimini-notice-extra">2021-04-17 11:55</div>
                            <div class="layuimini-notice-content layui-hide">
                                界面足够简洁清爽。<br>
                                一个接口几行代码而已直接初始化整个框架，无需复杂操作。<br>
                                支持多tab，可以打开多窗口。<br>
                        ...
                        <div class="layuimini-notice">
                            ...
                            <div class="layuimini-notice-extra">2021-04-13 14:53</div>
                            <div class="layuimini-notice-content layui-hide">
                                界面足够简洁清爽。<br>
                                一个接口几行代码而已直接初始化整个框架，无需复杂操作。<br>
                                支持多tab，可以打开多窗口。<br>
