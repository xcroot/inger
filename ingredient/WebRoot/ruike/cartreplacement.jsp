...
<div class="layuimini-main"> 
	    ...
	    <div class="layui-col-md">
	              <form class="layui-form"  method="">
					        ...
					        <div class="layui-form-item">
					            <label class="layui-form-label required">厂家:</label>
					            <div class="layui-input-block">
					                 <input type="text" id="material_provider" class="layui-input" name="material_provider" size="20">
					            </div>
					        </div>
					        <div class="layui-form-item">
					            <label class="layui-form-label required">所属设备:</label>
					            <div class="layui-input-block">
					                 <input type="text" id="equipment_use" class="layui-input" name="equipment_use" size="20">
					            </div>
					        </div>
					        <div class="layui-form-item">
					            <label class="layui-form-label required">申购原因:</label>
					            <div class="layui-input-block">
...
<script>
    ...
    layui.use(['form'],function(){
        ...
        form.on('submit(saveBtn)',function(data){
             ...
             lock = true;
              $.ajax({
                  url:'/ingredient/ruike/buyreplacementorder.do',//发出请求
                  type:'post',
                  data:{"purchase_id":data.purchase_id,"material_id":data.material_id,"material_name":data.material_name,
                        ...
                        "num":data.num,"material_provider":data.material_provider,"equipment_use":data.equipment_use,"reason":data.reason,
                        "opdate":data.opdate,"dept_name":data.dept_name,"worktype_name":data.worktype_name,
