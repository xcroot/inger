    ...
    <div class="splayui-main">
       ...
       <!--   <table class="layui-hide" id="currentTableId" lay-filter="currentTableFilter"></table> -->
        <table class="layui-table" id="currentTableId"  lay-filter="currentTableFilter">
           <thead>
           		<tr>
           		   ...
           		   <th lay-data="{field:'deptName', width:180}">部门编码</th>
           		   <th lay-data="{field:'workTypeName', width:180}">岗位</th>
           		   <th lay-data="{field:'opdate', width:180}">生成日期</th>
           		   <th lay-data="{field:'operator', width:180}">申请人</th>
           		   <th lay-data="{field:'status', width:180}">申请状态</th>
           		   <th lay-data="{field:'dealDate', width:180}">处理日期</th>
           		   <th lay-data="{field:'dealer', width:180}">处理人</th>
		...
		<%
				...
				List<ApplyOrder> items = (List<ApplyOrder>)request.getAttribute("orderall");
				for(int i=0;i<items.size();i++){
					ApplyOrder item = items.get(i);
					%>
					<tr>
						<td>
							<%=item.getPurchaseId()%>
						...
						<td>
							<%=item.getDealDate() == null? "":item.getDealDate()%>
						</td>
						<td>
							<%=item.getDealer()== null? "":item.getDealer()%>
						</td>
						<td>
